							...
							<div class="catagori-content">
								...
								<div class="pros-cons-block">
									...
									<p class="coins-detail">
										...
										<span class="coins-match"><a href="" data-toggle="modal" data-target="#tk_transfer">Transfer</a></span>
									</p>
									<hr class="wal_hr">
									<div class="pros-block">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active show" id="dlike_trx">
							<table class="table coin-list table-hover">
								...
								<tbody>
									<?php
									$sqlt = "SELECT username, amount, reason FROM transactions where username='$user_wallet' AND reciever='$user_wallet' ORDER BY trx_time DESC";
