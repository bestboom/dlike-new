                            ...
                            <div role="tabpanel" class="tab-pane fade active show" id="nav_mycelium">
                                <div class="catagori-content">
                                    ...
                                    <div class="pros-cons-block">
                                        ...
                                        <p style="font-size: 0.7rem;margin-top: -12px;">Native Token for STEEM Blockchain<span style="color: #1652f0;font-weight: 700;">Transfer</span></p>
                                        <hr style="margin-top: 0.2rem;">
                                        <div class="pros-block" style="justify-content: space-between;">
                                            <h5 class="base-color">STEM DOLLAR: </h5><p>312 SBD</p>
                                        </div>
                                        <p style="font-size: 0.7rem;margin-top: -12px;">Basic STEEM token valued at dollar<span style="color: #1652f0;font-weight: 700;">Transfer</span></p>
                                        <hr style="margin-top: 0.2rem;">
                                        <div class="pros-block" style="justify-content: space-between;">
