                            ...
                            <div class="catagori-content">
                                ...
                                <div class="pros-cons-block">
                                    ...
                                    <p class="coins-detail">
                                        ...
                                        <span class="coins-match"><a href="" data-toggle="modal"
                                                                     data-target="#tk_transfer">Transfer</a></span>
                                    </p>
                                    <hr class="wal_hr">
                                    <div class="pros-block">
                        ...
                        <div role="tabpanel" class="tab-pane fade active show" id="nav_mycelium">
                            <div class="catagori-content">
                                ...
                                <div class="pros-cons-block">
                                    ...
                                    <p class="coins-detail">Native Token for STEEM Blockchain<span class="coins-match">Transfer</span>
                                    </p>
                                    <hr class="wal_hr">
                                    <div class="pros-block">
                                    ...
                                    <p class="coins-detail">Basic STEEM token valued at dollar<span class="coins-match">Transfer</span>
                                    </p>
                                    <hr class="wal_hr">
                                    <div class="pros-block">
                            ...
                            <div class="catagori-content"><!-- TIPS-content-ends -->
                                ...
                                <div class="pros-cons-block" style="padding-top: 20px;">
                                    ...
                                    <p class="coins-detail">A stable coin by Bitfinex<span class="coins-match"><a
                                                    href="" data-toggle="modal" data-target="#tk_withdraw">Withdraw</a></span>
                                    </p>
                                    <hr class="wal_hr">
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="nav_nano">
                            <div class="catagori-content">
                                <p class="catagori-info">
                                    ...
                                    users cane arn DLIKE tokens on daily basis through reward pool. To become PRO, users
                                    are required to burn 10,000 DLIKE tokens.
                                </p>
                                <p>
                                    DLIKE token is not yet listed on exchanges so it can be purchased here at a price of
                                    0.025 USD.
                                </p>
                                <div class="pros-cons-block">
                            ...
                            <table class="table coin-list table-hover">
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            <td><span class="btn btn-icon btn-exp"><span
                                                            class="text-dark">Tx</span></span></td>
                                            <td class="exp-user">For <span><?php echo $trx_status; ?></span></td>
                                            <td class="exp-amt"><span
                                                        id="tk-amt"><?php echo(number_format($row["amount"])); ?></span>
                                                DLIKE
                                            </td>
                                        </tr>
                                    <? }
                                ...
                                if ($result_tip->num_rows > 0) {
                                    while ($row_tip = $result_tip->fetch_assoc()) { ?>
                                        <tr>
                                            ...
                                            <td class="exp-amt"><span
                                                        class="color-sell"><?php echo '<a href="/post/@'.$user_wallet.'/'.$row_tip["permlink"].'">Link</a>'; ?></span>
                                            </td>
