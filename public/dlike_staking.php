                        ...
                        <div role="tabpanel" class="tab-pane fade in active show" id="stake_dlike">
                            <div class="container"><div class="row stk_row">
                                <div id="stake_sub stk90"> 
                                    ...
                                    <center><button type="button" class="btn btn-primary" id="stake_me stk30">Stake</button></center>
                                </div>
                        </div></div></div>
                        <div role="tabpanel" class="tab-pane fade" id="unstake_dlike">
                             <div class="container">
                                <div id="unskae_row" class="row stk_row">
                                    <div id="stake_sub stk90"><p>Loading...</p></div>
                                </div>
                                <div id="unstake_row" class="row stk_row not_me">
                                    <div id="stake_sub stk90">
                                        ...
                                        <center><button type="button" class="btn btn-primary" id="unstake_me stk30">Unstake</button></center>
                                    </div>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="claim_dlike">
                            <div class="container"><div class="row stk_row">
                                <div id="stake_sub stk90">
                                    ...
                                    <center><button type="button" class="btn btn-primary" id="claim_stk_reward stk30">Claim</button></center>
                                </div>
                        </div></div></div>
                </div></div>
            </div>
