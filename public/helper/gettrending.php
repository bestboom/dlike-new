<?php
	...
	if ($result->num_rows > 0) {
		$html = '<a class="nav-item nav-link active" id="public-chat-tab" data-toggle="tab" href="#publicChat" role="tab" aria-controls="public" aria-expanded="true" style="font-weight: 900">Trending now ></a>';
		$trending_html = '';
		$counter = 0; 
