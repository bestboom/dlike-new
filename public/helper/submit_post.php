...
$postGenerator = new dlike\post\makePost();
	...
	// insert into DB	
		...
		$addposts = "INSERT INTO steemposts (`username`,`title`, `permlink`, `post_tags`, `ext_url`, `ext_url`, `parent_ctegory`,`created_at`) VALUES ('".$_COOKIE['username']."','".$title."', '".$permlink."', '".$tags."', '".$url."', '".$urlImage."', '".$category."','".date("Y-m-d H:i:s")."')";
