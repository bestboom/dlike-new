...
if(!$user_profile_pic){$user_profile_pic="/images/user.png";}
?>
...
<div class="post-thumb img-fluid"><?php echo '<a href="/post/'.$author.'/'.$permlink.'"><img data-src=' . $imgUrl . ' class="card-img-top lazyload" alt=' . $permlink . ' /></a>'; ?></a></div>
...
<div><img src="/images/post/dlike-hover.png" alt="DLIKE" class="hov_vote" data-permlink="<?php echo $permlink; ?>" data-author="<?php echo $author; ?>"> | <span id="post_likes" class="post_likes<?php echo $permlink; ?><?php echo $author; ?>"><?php echo $postLikes; ?></span>LIKES</div>
