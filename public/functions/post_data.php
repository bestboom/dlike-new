...
<div><?php echo '<a href="/profile/'. $author.'"><img src="'.$user_profile_pic.'" alt="'.$author.'" style="width: 32px;border-style: solid !important;border-color: #fff;border-radius:1rem;"></a>'; ?></div>
