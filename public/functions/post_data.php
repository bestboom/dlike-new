...
<div><?php echo '<a href="/profile/'. $author.'"><img src="'.$user_profile_pic.'" alt="'.$author.'"  class="img-fluid my_img" id="profileImg"></a>'; ?></div>
...
<div class="post-thumb img-fluid"><?php echo '<a href="/post/'.$author.'/'.$permlink.'"><img src=' . $imgUrl . ' onerror="postImgError(this);" class="card-img-top" /></a>'; ?></a></div>
