...
<div><?php echo '<a href="/profile/'. $author.'"><img src="'.$user_profile_pic.'" alt="'.$author.'" style="width: 32px;border-style: unset !important;border-color: #ccc;border-radius:1rem !important;display:block;"></a>'; ?></div>
