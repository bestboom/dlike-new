...
<? } ?>
<link rel="apple-touch-icon"sizes="180x180"href="https://dlike.io/images/favicons/apple-touch-icon.png?v=kPvWrWRLXe"><link rel="icon"type="image/png"sizes="32x32"href="https://dlike.io/images/favicons/favicon-32x32.png?v=kPvWrWRLXe"><link rel="icon"type="image/png"sizes="16x16"href="https://dlike.io/images/favicons/favicon-16x16.png?v=kPvWrWRLXe"><link rel="manifest"href="https://dlike.io/images/favicons/site.webmanifest?v=kPvWrWRLXe"><link rel="shortcut icon"href="https://dlike.io/images/favicons/favicon.ico?v=kPvWrWRLXe"><meta name="apple-mobile-web-app-title"content="DLIKE"><meta name="application-name"content="DLIKE"><meta name="msapplication-TileColor"content="#2d89ef"><meta name="msapplication-config"content="https://dlike.io/images/favicons/browserconfig.xml?v=kPvWrWRLXe">
<meta name="theme-color" content="#ffffff">
<link href="https://fonts.googleapis.com/css?family=Quicksand" rel="stylesheet">
<link rel="stylesheet" href="/css/style.css">
<?php if(basename($_SERVER['PHP_SELF']) == 'welcome.php'){ ?> <link rel="stylesheet" href="/css/intlTelInput.css"><? } ?> 
</head>
<body>
<?php include('promo/top-sticky.php'); ?>
<div class="sidenav"id="mySidenav"style="z-index:222222"><a href="javascript:void(0)"class="closebtn"onclick="closeNav()">×</a><?php if(isset($_COOKIE['username'])||!empty($_COOKIE['username'])){ ?><a href="/wallet">Wallet</a> <a href="/dliker">DLIKER</a><? }else{} ?><a href="/rewards">Reward Pool</a> <a href="/staking">Staking</a> <a href="/explorer">Explorer</a> <a href="/help">FAQ</a><?php if(isset($_COOKIE['username'])||!empty($_COOKIE['username'])){echo '<a href="javascript:void(0)" class="logout_btn">Logout</a>';}else{} ?><br><a href="/token">Token</a> <a href="/docs/dlike-paper.pdf">Whitepaper</a></div>
<div class="banner-block"><nav class="navbar main-nav navbar-expand-lg"><div class="container"><a href="/"class="navbar-brand"><img class="navbar-logo"src="/images/logo.png"alt="Dlike"> </a><button class="navbar-toggler collapsed"type="button"data-toggle="collapse"data-target="#navbarSupportedContent"aria-controls="navbarSupportedContent"aria-expanded="false"aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button><div class="collapse navbar-collapse"id="navbarSupportedContent"><ul class="navbar-nav ml-auto"><li class="nav-item"style="padding-top:4px"><div class="row"style="margin:0"><div class="col-md-3 col-2"><?php if(!isset($_COOKIE['username'])||!$_COOKIE['username']){ ?><button onclick='window.location.href="/welcome"'type="button"class="btn btn-default btn-circle-it btn-lg custom_btn_icon search_btn_hover"><i class="fas fa-user"></i></button><? }else{ ?><button onclick='window.location.href="/@<? echo $_COOKIE['username']; ?>"'type="button"class="btn btn-default btn-circle-it btn-lg custom_btn_icon search_btn_hover"><span class="img_profile"><img src="/images/user.png"alt="<? echo $_COOKIE['username']; ?>"title="<? echo $_COOKIE['username']; ?>"id="user_img"class="rounded-circle img-fluid"style="background:#fff;margin-top:-6px"></span></button><? } ?></div><div class="col-md-4 col-2"><button onclick='window.location.href="/share"'id="btn_share"type="button"class="btn btn-default btn-circle-it btn-lg custom_btn_icon edit_btn_hover"><i class="fa fa-pencil-alt"></i></button></div><div class="col-md-4 col-2"style="margin-top:5px"><span class="nav_sticks"onclick="openNav()">☰</span></div></div></li></ul></div></div></nav>