                        ...
                        <li class="nav-item" style="padding-top: 4px;">
                            <div class="row" style="margin: 0px;">
                                <div class="col-md-3 col-2">
                                    ...
                                    <? } else { ?>
                                    <button onclick="window.location.href='/@<? echo $_COOKIE['username']; ?>';" type="button" class="btn btn-default btn-circle-it btn-lg custom_btn_icon search_btn_hover"><span class="img_profile"><img src="" alt="<? echo $_COOKIE['username']; ?>" id="user_img" class="rounded-circle img-fluid" style="background: #fff;margin-top: -6px;"></span>
                                    </button><? } ?>
                                </div>
