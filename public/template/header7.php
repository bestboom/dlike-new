...
<a href="/help">FAQ</a>
<?php if (isset($_COOKIE['dlike_username']) || !empty($_COOKIE['dlike_username'])) { echo '<a id="logout_btn">Logout</a>';} else { } ?><br>
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item" style="padding-top: 4px;">
                <div class="row top_nav">
                    <div class="col-md-3 col-2"><?php if (isset($_COOKIE['dlike_username']) || $_COOKIE['dlike_username']) { ?>
                        <button onclick="window.location.href='/<?php echo $_COOKIE['dlike_username']; ?>';" type="button" class="btn btn-default btn-circle-it btn-lg custom_btn_icon search_btn_hover"><i class="fas fa-user"></i></button>
                        ...
                        <button onclick="window.location.href='/welcome';" type="button" class="btn btn-default btn-circle-it btn-lg custom_btn_icon search_btn_hover"><i class="fas fa-user"></i></button><? } ?>
                    </div>
                    <div class="col-md-4 col-2"><button onclick="window.location.href='/share';" id="btn_share" type="button" class="btn btn-default btn-circle-it btn-lg custom_btn_icon edit_btn_hover"><i class="fa fa-pencil-alt"></i>
                        </button></div>
