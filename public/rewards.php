        ...
        <div class="row">
            ...
            <div class="offset-lg-1 col-lg-5 col-md-6">
                <div class="user-connected-form-block" style="box-shadow: 0px 0px 10px 1px #cccccc;">
                    ...
                    <div class="btn btn-default" style="border-radius: 4px;"><span class="far fa-clock" style="font-size: 1.4rem;padding-right: 1rem;"></span><span class="dividendCountDown" style="font-size: 1.7rem;"></span></div>
