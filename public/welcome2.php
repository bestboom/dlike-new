                            ...
                            <div class="contact-info-inner" style="margin-top: 10%;">
                                ...
                                <form name="email-signup-pin" style="margin-left: 15%;margin-right: 15%;margin-top: 10px;width: unset;float: none;">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" name="email-pin" id="email_pin_code" placeholder="confirmation code (6 digits)" class="form-control" />
                                    </div>
...
$('.email_signup_btn').click(function() {$('.signup_loader').show();
    ...
    if(signup_email==""){toastr.error('phew...Email should not be empty');$('.signup_loader').hide();return false;
        ...
        if (!emailRegex.test(signup_email)) {toastr.error('phew... email address is not valid'); $('.signup_loader').hide();return false;}
    }
...
$('.email_verify_pin_btn').click(function() {$(".email_verify_pin_btn").attr("disabled", true);
    ...
    $.ajax({type: "POST",url: 'helper/email_verify.php',
        data: data_verify,
        success: function(data) {
            try {var response = JSON.parse(data)
