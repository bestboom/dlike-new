                ...
                $(content).append('<div class="col-lg-4 col-md-6">\n' +
                	...
                	'<div class="post-contnet-wrap-top">\n' +
                        ...
                        '<div class="post-contnet-wrap">\n' +
                        	'\n' +
                            '<div class="hov-wrap"><a class="hov-txt" data-toggle="modal" data-target="#likes" data-permlink="' + $post.permlink + '" data-author="' + $post.author + '"><span id="hov-num">0</span></a><div><img src="./images/post/dlike-hover.png" alt="img" class="img-responsive dlike-hov"></div></div>\n' +
                            '\n' +
