		...
		res.forEach(($post, i) => {
			...
			if(metadata && metadata.community == "dlike"){
				...
				$(content).append('<div class="col-lg-4 col-md-6 postsMainDiv mainDiv'+ currentLikesDivElement +'" postLikes="0" postNumber="'+ currentPostNumber +'">\n' +
					...
					'\n' +
					'<div class="row d-flex justify-content-center hov-it"><div class="hov-wrap"><img src="./images/post/dlike-hover.png" alt="img" class="img-responsive"><a class="hov-txt" data-toggle="modal" data-target="" data-permlink="' + $post.permlink + '" data-author="' + $post.author + '"><span id="hov-num" class="commentsDiv' + currentLikesDivElement + '">0</span></a></div></div>\n' +
                    '\n' +
