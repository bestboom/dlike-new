		...
		res.forEach(($post, i) => {
			...
			if(metadata && metadata.community == "dlike" ){
				...
				$(content).append('<div class="col-lg-4 col-md-6 postsMainDiv mainDiv'+ currentLikesDivElement +'" postLikes="0" postNumber="'+ currentPostNumber +'">\n' +
					...
					'<div class="post-footer">\n' +
					'<div class="post-author-block">\n' +
					'<div class="author-info"><i class="fas fa-dollar-sign"></i><span>&nbsp;' + $post.pending_payout_value.substr(0, 4) + '</span> <b>+</b> <span id="se_token'+$post.permlink +$post.author +'">0</span> <b>DLIKER</b><span id="similar" class="vtme"  data-popover="true" data-html="true" data-content="<ul>' + $post["vote_info"] + '</ul>">Upvotes</span></div>\n' +
					'</div>\n' +
