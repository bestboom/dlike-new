...
include_once 'spatie/image-optimizer/src/OptimizerChainFactory.php';
include_once 'spatie/image-optimizer/src/OptimizerChain.php';
include_once 'spatie/image-optimizer/src/DummyLogger.php';
