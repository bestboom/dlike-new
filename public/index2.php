...
<div class="col-lg-4 col-md-6 postsMainDiv"><article class="post-style-two">
    ...
    <div class="author-info"><span class="dlike_tokens" data-popover="true" data-html="true" data-content=""><?php echo $post_income; ?></span> <b>DLIKE</b></div>
    </div></div></div>
</article></div>
<?php } } ?> 
</div></div></div>
                ...
                success: function(data) {
                    try {
                        ...
                        if (response.error == true) {
                            ...
                            $('.dlike_tokens').html(response.postIncome);
                            $('#recomendModal').modal('hide');
                            $('#recomend-status').hide();
                            $('#recomend-bar').show();
                        }
