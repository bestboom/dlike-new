        ...
        <div class="post-contnet-wrap">
            <div class="post-footer" style="margin-bottom: 20px;">
                <div class="post-author-block">
                    <div class="img-fluid"><?php echo '<a href="/profile/'.$author.'"><img src="'.$profile_pic.'" alt="'.$author.'" style="width: 32px;margin-right: 9px;border-top-left-radius: 1rem;border-top-right-radius: 1rem;border-bottom-left-radius: 1rem;border-bottom-right-radius: 1rem;"></a>'; ?></div>
