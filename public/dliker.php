...
<script>
    ...
    $('.transfer_btn').click(function(clickEvent) {
        ...
        let transfer_url =  '<?php echo "https://v2.steemconnect.com/sign/custom-json?required_auths=" . urlencode(json_encode(["cadawg"])) . "&required_posting_auths=" . urlencode("[]") . "&id=ssc-mainnet1" . urlencode(json_encode(["contractName" => "tokens","contractAction" => "transfer","contractPayload" => ["symbol" => "DLIKER","quantity" =>".448"]])); ?>';
