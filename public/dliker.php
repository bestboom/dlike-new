...
<?php include "./template/footer.php"; ?>
                <script>
                    ...
                    function unstakeDliker() {
                        if(window.steem_keychain) {
                            steem_keychain.requestCustomJson("<?php echo $user_name; ?>", "ssc-mainnet1", "active", '{"contractName":"tokens","contractAction":"unstake","contractPayload":{"symbol":"DLIKER","quantity":"100"}}', "Unstake 0.488 DLIKER Tokens", function(response) {
                                if (response.success) {
