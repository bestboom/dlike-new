...
} else {$dlike_user = 'none';}	$login_user = $_COOKIE['dlike_username']; ?>
</div>
...
<? } ?>
<script>let dlik_profname='<?php echo $_GET['user'];?>';let email_id='<?php echo $email;?>';</script>
...
$('.email_pin_btn').click(function() {$(".email_pin_btn").attr("disabled", true);
    let pin_code = $('#email_pinit_code').val();let user_email_id = email_id;
...
$('.resend_pin').click(function() {$('.resend_pin').html("Sending...");let user_email_id = email_id;
