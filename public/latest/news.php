...
<div class="faq-section" style="padding-top:1px;padding-bottom: 0px;"><div class="container news-set"><div class="row" style="margin: 0px">
    <div class="col-md-8">
        <div class="row" style="margin: 2px;font-size: 0.85rem;color: #c51d24;"><a href="/latest">Latest News </a> &nbsp; > &nbsp; <a href="/latest/<?php echo ucfirst($news_category); ?>"> <?php echo ucfirst($news_category); ?></a></div>
