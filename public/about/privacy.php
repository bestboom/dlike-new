...
<div class="container">
	<div class="info-sec">
		...
		<p>We collect the content and other information you provide when you use our Services. This includes information used to create your account (e.g. username, phone number), account preferences and the content of information you post to the Services (e.g. text, photos, videos, links).</p>
		<h3>1.2. Transactional Information</h3>
		<p>If you purchase products or services from us (e.g. DLIKE Tokens), we will collect certain information from you, including your name, address, email address, and information about the product or service you are purchasing. Payments are processed by third-party payment processors (e.g. Stripe and PayPal), so please refer to the applicable processor's terms and privacy policy for more information about how payment information is processed and stored.</p>
		...
		<p>When you access or use our Services, we may also automatically collect information about you. <br>
		This includes:</p>
