...
$sql_data = $conn->query("INSERT INTO dlike_rewards_history (yesterday_upvotes, dlike_staking, dlike_dao, dlike_charity, dlike_team, dlike_foundation, dlike_airdrop, update_time) VALUES ('".$total_upvotes."', '".$staking_reward."', '".$dao_reward."', '".$charity_reward."', '".$team_reward."', '".$foundation_reward."', '".$airdrop_reward."', '".date("Y-m-d H:i:s")."')");
?>